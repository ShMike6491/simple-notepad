...
import com.sh.michael.simple_notepad.feature_menu.di.menuModule
...
val appModules = listOf(appModule, notesModule, pagesModule, filesModule, homeModule, menuModule)